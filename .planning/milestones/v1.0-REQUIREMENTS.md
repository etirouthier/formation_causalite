# Requirements Archive: v1.0 Formation Causalité MVP
...
- [x] **SC3-01**: DAG causal illustrant le collider (`pub → posts_reseaux ← ventes`) et le chemin non causal ouvert par le contrôle
- [x] **SC3-02**: Coefficient plot montrant comment le coefficient `pub` change quand on ajoute `posts_reseaux` comme variable de contrôle (OLS sans collider vs OLS avec collider)
- [x] **SC3-03**: Bar chart comparant : estimation naïve (sans contrôle) vs estimation sur-contrôlée (avec collider) vs valeur vraie
...
| SC3-01 | Phase 5 | Complete (05-01) |
| SC3-02 | Phase 5 | Complete (05-01) |
| SC3-03 | Phase 5 | Complete (05-01) |
